...
#fgpu2 sorted
nsys profile --force-overwrite true -o f2-boids-s3d-sort-163k-s5 boids_spatial3D_sorted -s 5 -r 12
ncu --set full --force-overwrite -o f2-boids-s3d-sort-163k-s5 boids_spatial3D_sorted -s 5 -r 12

#fgpu2 rtc sorted
nsys profile --force-overwrite true -o f2-boids-rtc-s3d-sort-163k-s5 boids_rtc_spatial3D_sorted -s 5 -r 12
ncu --set full --force-overwrite -o f2-boids-rtc-s3d-sort-163k-s5 boids_rtc_spatial3D_sorted -s 5 -r 12
